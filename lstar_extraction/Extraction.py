...
def extract(rnn, alphabet, traces, time_limit = 50,initial_split_depth = 10,starting_examples=None):
	...
	start = clock()
	try:
	    run_lstar(guided_teacher,time_limit, alphabet, traces)
	...
	return dfa, guided_teacher.ltl_formulas[-1]